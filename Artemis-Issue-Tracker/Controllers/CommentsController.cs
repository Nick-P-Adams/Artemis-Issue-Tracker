...
namespace Artemis_Issue_Tracker.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Item,CreationDate")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Item,CreationDate")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
